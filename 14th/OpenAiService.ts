...
export default class OpenAiService {
  ...
  public async extractNamesAndCities({
    string,
  }: {
    string: string;
  }): Promise<string> {
      ...
      messages: [
        {
          role: "system",
          content:
            "Dostaniesz string, który będzie zawierał rózne imiona i miasta. Twoim zadaniem jest wyciągnięcie imion i miast z tego stringa. Odpowiedz jsonem, która zawiera te imiona i miasta - mają być w mianowniku bez polskich znaków - nie formatuj wielkości liter. Przykład: 'Jan Kowalski, WARSZAWA, Anna Nowak, Kraków, Grześkowi, Azazel' - odpowiedź: {cities: ['Krakow', 'WARSZAWA'], names: ['Jan', 'Anna', 'Grzesiek', 'Azazel']}. Jeśli nie ma żadnych imion lub miast to odpowiedz taką samą strukturą ale z pustymi tablicami.",
        },
        {
          role: "user",
          content: string,
